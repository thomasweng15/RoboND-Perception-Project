...
def compute_normal_histograms(normal_cloud):
    ...
    x_hist = np.histogram(norm_x_vals, bins=64, range=(0, 256))
    y_hist = np.histogram(norm_y_vals, bins=64, range=(0, 256))
    z_hist = np.histogram(norm_z_vals, bins=64, range=(0, 256))
